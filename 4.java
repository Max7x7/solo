...
public class MyDownloadApp {
    ...
    private static final String SERVICE_ACCOUNT_JSON_FILE = "/home/rompvmrix/cedar-gift-398323-f00c59996387.json"; // Укажите путь к вашему файлу ключа аутентификации
    private static final String DOWNLOAD_DIRECTORY = "/path/to/download/directory/"; // Укажите путь к папке, в которую вы хотите скачивать файлы

    public static void main(String[] args) throws Exception {
        HttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
        GoogleCredentials credentials = GoogleCredentials.fromStream(
                MyDownloadApp.class.getResourceAsStream(SERVICE_ACCOUNT_JSON_FILE)
